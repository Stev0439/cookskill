...
const ListRecipesIntentHandler = {
    canHandle(handlerInput) {
        return Alexa.getRequestType(handlerInput.requestEnvelope) === 'IntentRequest'
            && Alexa.getIntentName(handlerInput.requestEnvelope) === 'ListRecipesIntent';
    },
    handle(handlerInput) {
        const speakOutput = 'Here are your recipes';
...
const InstructionsIntentHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Lets move on to the instructions';
